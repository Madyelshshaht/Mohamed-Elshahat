    ...
    return (
        <>
            ...
            {filteredProjects.length > 0 ? (
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="desc mb-2 text-xs md:text-md lg:text-lg">
                                        {pro.desc}
                                    </div>
                                    ...
                                    <div className="links p-2 flex items-center gap-5">
                                        <Link to={pro.deployLink} target="_blank">
                                            <ExternalLink size={20} />
                                        </Link>
                                        <Link to={pro.githubLink} target="_blank">
                                            <GitHub style={{ fontSize: "22px" }} />
                                        </Link>
                                    </div>

                                    {token && (
                                        <div className="links p-2 flex items-center gap-2">
                                            <button
                ...
                <h1 className="text-center sm:text-3xl text-2xl font-bold">
                    No Projects Found
                </h1>
            )}
        </>
